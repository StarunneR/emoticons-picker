    ...
    [, , , , , , , function (t, e, n) {
        ...
        var d = function (t) {
            ...
            p = [{
                ...
                title: "哈 ∀",
                items: ["(・∀・)", "(ﾟ∀ﾟ)", "(*ﾟ∀ﾟ*)", "(*ﾟ∇ﾟ)", "(ノﾟ∀ﾟ)ノ", "(＾o＾)ﾉ", "(〃∀〃)", "(ゝ∀･)", "ᕕ( ᐛ )ᕗ", "(´∀`)", "(*´∀`)", "(ﾟ∀。)", "(`ヮ´)", "(`・´)"]
            }, {
                title: "蛤 σ",
                items: ["σ`∀´)", "ﾟ∀ﾟ)σ", "(σﾟ∀ﾟ)σ","(`ヮ´ )σ`∀´) ﾟ∀ﾟ)σ", "(σﾟдﾟ)σ"]
            }, {
                title: "唔 ω",
                items: ["(ﾟωﾟ)", "(oﾟωﾟo)", "(*´ω`*)", "(・ω・)", "(｀･ω･)", "(`・ω・´)", "(´・ω・`)", "(´・ω)", "(｀・ω)", "(　ˇωˇ)", "(=ﾟωﾟ)=", "ヾ(´ωﾟ｀)", "（<ゝω・）☆"]
            }, {
                title: "呵 ^",
                items: ["(^ω^)", "( ^ω^)", "(　^ω^)"]
            }, {
                title: "惊 дﾟ",
                items: ["(ﾟдﾟ)", "(´ﾟДﾟ`)", "(´ﾟДﾟ`)？？？", "(つд⊂)", "ﾟÅﾟ)", "(;ﾟдﾟ)", "(|||ﾟдﾟ)", "(　д ) ﾟ ﾟ", "Σ(ﾟдﾟ)", "(((ﾟдﾟ)))", "(((　ﾟдﾟ)))", "(ﾟДﾟ≡ﾟДﾟ)", "(☉д⊙)"]
            }, {
                title: "怒/悲 ´Д`",
                items: ["(`д´)", "(>д<)", "(´д`)", "(*´д`)", "(;´Д`)", "(╬ﾟдﾟ)", "(TдT)", "(-д-)", "ﾟ(つд`ﾟ)", "･ﾟ(ﾉд`ﾟ)"]
            }, {
                title: "無 _",
                items: ["(・_ゝ・)", "(´_ゝ`)", "( ´_ゝ`)旦", "(´_っ`)", "(`_っ´)", "(´ー`)", "(`ー´)", "(*ﾟーﾟ)", "(・ー・)",  "¯\\_(ツ)_/¯",]
            }, {
                title: "躲 |",
                items: ["|∀ﾟ", "|∀`)", "|д`)", "|дﾟ)", "|ω・´)", "|ー`)", "|-`)"]
            }, {
