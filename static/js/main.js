    ...
    [, , , , , , , function (t, e, n) {
        ...
        var d = function (t) {
            ...
            p = [{
                ...
                title: "蛤 σ",
                items: ["σ`∀´)", "ﾟ∀ﾟ)σ", "(σﾟ∀ﾟ)σ","(`ヮ´ )σ`∀´) ﾟ∀ﾟ)σ", "(ﾟ∀。)", "ᕕ( ᐛ )ᕗ", "(`ヮ´)", "(`・´)"]
            }, {
                title: "呵 ^",
                items: ["(^ω^)", "( ^ω^)"]
            }, {
                title: "惊 дﾟ",
                items: ["(ﾟдﾟ)", "(´ﾟДﾟ`)", "(´ﾟДﾟ`)？？？", "(д)ﾟﾟ", "(　д ) ﾟ ﾟ", "(;ﾟдﾟ)", "(σﾟдﾟ)σ", "Σ(ﾟдﾟ)", "(╬ﾟдﾟ)", "(|||ﾟдﾟ)", "(((ﾟдﾟ)))", "(ﾟДﾟ≡ﾟДﾟ)", "(☉д⊙)", "ﾟÅﾟ)"]
            }, {                
                title: "怒 д´",
                items: ["(`д´)", "(>д<)"]
            }, {
                title: "悲 д",
                items: ["(´д`)", "(*´д`)", "(;´Д`)", "(つд⊂)", "(TдT)", "(-д-)", "ﾟ(つд`ﾟ)", "･ﾟ(ﾉд`ﾟ)", "(๑ŐдŐ;)っ"]
            }, {
                title: "無 _",
